...
<!-- END BLOCK : msg --> 
<!-- START BLOCK : AddNew -->
<form action="{action}" method="post" id="inputform"  enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td><input type="text" name="title" class="txtform100 " value="{title}"/> </td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top"><strong>Thông tin hãng</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
