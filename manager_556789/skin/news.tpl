    ...
    <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
            ...
            <tr>
                ...
                <td><input type="checkbox" name="showdate" value="1" {showdate} /></td>
            </tr>
            ...
            <tr>
                <td><strong>Link GoogleNew </strong></td>
                <td> <input type="text" name="linkto" class="txtform100" value="{linkto}" /> </td>
            </tr>

            <!--
            <tr>
             <td><strong>Kích hoạt form đăng ký</strong></td>
             <td><input type="checkbox" name="form_name" value="1" {form_name} /></td>
           </tr>
            -->

            <tr>
                <td><strong>Ghim nổi bật</strong></td>
            ...
            <tr>
                ...
                <td>
                    <a href="{link_edit}">{image}</a>
                        <div class="list_item_name"><a href="{link_edit}">{name}</a> {hot}
                    </div>
