...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        <td valign="top"><strong>Cấp độ</strong></td>
        <td>
            <select name="level">
                <option value="2" {level2}>Chủ tịch HĐQT</option>
                <option value="1" {level1}>Sáng lập viên</option>
                <option value="0" {level0}>Lãnh đạo chủ chốt</option>
            </select>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td><input type="text" name="position" class="txtform100" value="{position}" /></td>
      </tr>
      
      <tr>
        <td><strong>Đơn vị công tác</strong></td>
        <td><input type="text" name="branch" class="txtform100" value="{branch}" /></td>
      </tr>
