...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        <td width="150"><strong>Quận/Huyện</strong></td>
        <td>
            <select id="vn_district" name="districtid">
        	{vn_district}
            </select> 
      ...
      <tr>
        <td width="150"><strong>Mã Phường Xã</strong></td>
        <td>
            <input type="text" name="wardid" class="txtform100 notNull" value="{wardid}" data-alert="Bạn cần nhập mã"/>
...
<form action="{action}" method="post" id="list_form">
  ...
  <div style="line-height: 40px;">
            ...
            Quận/huyện : 
            <select id="vn_district" name="districtid">
                <option value="00" selected="">-- Chọn quận huyện --</option>
        	{vn_district}
            </select>                    
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered table-striped table-hover">
  ...
  <tr>
    <th colspan="6">
        ...
        <a href="?page={par_page}&code=showAddNew&provinceid={provinceid}" style="float:right"><div class="btn  btn-mini"><i class="icon-plus-sign"></i>&nbsp;Thêm mới {item}</div></a>
    </th>
  </tr>
