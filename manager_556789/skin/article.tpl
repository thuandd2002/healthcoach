...
<div class="wraper-content">
    ...
    <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
            ...
            <tr>
                <td width="150"><strong> Tên tác giả</strong></td>
                <td><input type="text" name="author_name" class="txtform100" value="{author_name}"/></td>
            </tr>
            
            <tr>
                <td width="150"><strong>Email tác giả</strong></td>
                <td><input type="text" name="author_email" class="txtform100" value="{author_email}"/></td>
            </tr>            

            <tr>
                <td width="150"><strong>Thông tin tác giả</strong></td>
                <td><input type="text" name="author_info" class="txtform100" value="{author_info}"/></td>
            </tr>            
