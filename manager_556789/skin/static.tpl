...
<form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
      ...
      <tr>
        ...
        <td>
			<label class="radio"><input name="inwhere" type="radio" value="dieukhoan" {dieukhoan}>Điều khoản thanh toán</label>
            <label class="radio"><input name="inwhere" type="radio" value="contact" {contact}>Liên hệ</label>
