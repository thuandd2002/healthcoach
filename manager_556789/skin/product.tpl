...
<div class="wraper-content"> 
    ...
    <td><input type="text" name="color"  class="txtform100" value="{color}" /> </td>
</tr>	
            -->
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="size"  class="txtform100" style="width:290px;" value="{size}" /> (Size khác nhau cách nhau bằng dấu ",") </td>
            </tr>	
                        
            <tr>
                <td valign="top"><strong>Màu sắc</strong></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td colspan="2">

                Lấy mã màu tại đây: <input class='simple_color_color_code' style="font-size:16px;" value='#33cc33'/>

                <br/>
                                        
                                        
            <!-- START BLOCK : phienban -->
            <div class="phien-ban">
                <input type="text"  placeholder="Mã màu" name="tenphienban[]" value="{tenphienban}" style="width:200px; "  />
                <input type="text" style="width:20px; background:#{tenphienban};" />
                <input type="text" placeholder="Tên màu" name="motaphienban[]" value="{motaphienban}" style="width:400px;" />đ
            ...
            <!-- END BLOCK : phienban -->
            <div class="phien-ban">
                <input type="text"  placeholder="Mã màu" name="tenphienban[]"  style="width:200px;"  />
                <input type="text" placeholder="Tên màu" name="motaphienban[]"  style="width:400px;" />đ
            ...
            <tr>
                <td valign="top"><strong>Chi tiết sản phẩm</strong></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td valign="top"><strong>Thông số kỹ thuật</strong></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
			...
			<tr>
                <td><strong>Dự án liên quan </strong></td>
                <td>
				
				<select name="related_ids[]" multiple id="related_ids">
					{strRelatedIDs}
				</select>	
            ...
            <!--
            <tr>
                <td valign="top"> <strong>Video list</strong> </td>
                <td>&nbsp;</td>
            </tr>

            <tr>
                <td colspan="2"><textarea name="videourl" rows="5" style="width:800px">{videourl}</textarea> 
                    <br/>
                    <em>(Video trên Youtube, mỗi 1 video 1 dòng, cuối dòng có dấu ";")</em> 
                </td>
            </tr>	
            -->
            <tr>
            ...
            <!--
            <tr >
                <td valign="top"><strong>Sản phẩm liên quan</strong></td>
                <td>
                    <div style="display: none;">
                        <input type="text" name="spcungloainame" id="spcungloainame" value="{spcungloainame}" style="width:250px; margin-bottom:5px;" placeholder="Tiêu đề SP cung loại">
                    </div>
...
<tr >
        ...
        <div style="width:200px;">
            ...
            <tr>
                ...
                <td><a class="btn btn-primary" onclick="$('#inputform').submit();
                    ...
                    <a class="btn btn-warning" onclick="saochep();"  ><i class="icon-ok-circle icon-white"></i>&nbsp;Sao chép</a>			
    ...
    <script type="text/javascript">
        ...
        function saochep() {
            $('#inputform').attr('action', '{action_saochep}');
            $('#inputform').submit();
            return false;
        }
