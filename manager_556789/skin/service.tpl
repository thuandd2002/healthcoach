...
<div class="wraper-content">
    ...
    <form action="{action}" method="post" id="inputform" onSubmit="return check_null();" enctype="multipart/form-data">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-bordered tabletdnone">
            ...
            <tr>
                <td><strong>Ảnh phụ</strong></td>
                <td>
                    <div id="pic_avataradv">{pic_avataradv}</div>
                    <div class="c5"></div>
                    <div class="input-append">
                        <input name="imageadv" type="text" id="imageurladv"  style="height:20px; width:290px;" value="{imageadv}"/>
			...
			<!--
			<tr>
                <td valign="top"><strong>Nội dung các buổi học</strong></td>
                <td>&nbsp;</td>
            </tr>
            
            <tr>
                <td colspan="2">
                    <div>Hãy bấm Lưu khoá học sau đó mới cập nhật nội dung các buổi học</div>
                    <a class="btn btn-warning"  href="?page=service_detail&pid={id_service}" target="_blank" ><i class="icon-ok-circle icon-white"></i>&nbsp;Nội dung các buổi học</a>
