...
$tpl = new TemplatePower("skin/product_manufacture.tpl");
$tpl->prepare();
$id = intval($_GET['id']);
$idc = intval($_GET['idc']);
$pid = intval($_GET['pid']);
$module = new Product_Manufacture();
$module->_int();
$tpl->printToScreen();


class Product_Manufacture extends cat_tree {
    private $page = "Danh mục hãng sản xuất";
    private $item = "Hãng sản xuất";
    private $table = "product_manufacture";
    private $id_item = "id";
    private $par_page = "product_manufacture";
    private $data_type = 'product_manufacture';
