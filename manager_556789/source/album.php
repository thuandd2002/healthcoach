...
$tpl = new TemplatePower("skin/album.tpl");
$tpl->prepare();
...
class Album extends cat_tree {

    private $page = "Trang hình ảnh";
    private $item = "Album";
    private $table = "album";
    private $id_item = "id_album";
    private $par_page = "album";
    private $numberPageShow = 8;
    private $numberItemPage = 30;
    private $data_type = 'album';
    ...
    private function showList() {
        ...
        while ($rs = $DBi->fetch_array($db['db'])) {
            ...
            /*
              $url = $clsUrl->builUrl($rs['name'], ".htm", 1);
              $DBi->query("UPDATE news SET url = '$url' WHERE id_news = $rs[id_news]");
             */
        }
